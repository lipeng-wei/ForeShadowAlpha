...
/* begin edit by lipeng_wei
   对jquery 1.11.1版本 进行扩展 使其支持 $.browser 方法，已达到兼容之前组件
*/
...
~function($, window, undefined) {
    ...
    dialog.fn = dialog.prototype = {
        init: function(options) {
            ...
            this._shown     = options.shown || function(){};
            ...
            this.close      = options.close != true ? false : true;
        ...
        createHTML: function() {
            ...
            if (this.title!==false) {
                ...
                if (this.close) {
                    html += '<h2 class="title-left">' + this.title + '</h2>' +
                        '<a href="javascript:void(0);" title="关闭" class="close">X</a>' +
                        '</div>';
                } else {
                    html += '<h2 class="title-center">' + this.title + '</h2></div>';
                }
        ...
        show: function() {
            ...
            setTimeout(function() {
                ...
                if(that._shown.call(that)===false)return;
            }, this.effect?50:0);    
