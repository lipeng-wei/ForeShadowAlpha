...
class DigGoodStock extends Task{
    ...
    public static function getList(){
        $importFile = self::$thisTaskDataPath. '20160201_20160218_Good.EBK';
        $exportFile = self::$thisTaskDataPath. '20160201_20160218_Good.List.txt';
    ...
    public static function addInfo(){
        $importFile = self::$thisTaskDataPath. '20160201_20160218_Good.List.txt';
        $exportFile = self::$thisTaskDataPath. '20160201_20160218_Good.Table.txt';
